						...
						for (var e = 0; e < d.columns.editable.length; e++) {
							...
							n.each(function() {
								...
								if ("undefined" != typeof d.columns.editable[e][2]) {
									...
									t.each(jQuery.parseJSON(d.columns.editable[e][2]), function(
										t,
										e
									) {
										a +=
					...
					toolbar: function() {
						if (d.editButton || d.deleteButton) {
							...
							0 === i.find("th.tabledit-toolbar-column").length &&
								i
									.find("tr:first")
									.append('<th class="tabledit-toolbar-column"></th>'),
								d.editButton &&
									(t =
							...
							i.find("tr:gt(0)").append(
								'<td style="white-space: nowrap; width: 1%;">' + o + "</td>"
							);
						}
					},
				},
					...
					i !== !1 &&
						(t(e).each(function() {
							...
							t(this)
								.find(".tabledit-span")
								.text(
									e.is("select") ? e.find("option:selected").text() : e.val()
								),
								u.view(this);
						}),
						(s = t(e).parent("tr")));
			...
			d.editButton
				...
				: (i.on(
				  ...
				  i.on("change", "select.tabledit-input:visible", function() {
						event.handled !== !0 &&
							(b.submit(t(this).parent("td")), (event.handled = !0));
				  }),
