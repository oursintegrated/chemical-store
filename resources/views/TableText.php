...
class TableText
{
     ...
     * @param string $line the line base text to separate header, content and footer. default - 
     * @param string $border the border base text default | 
     */
    ...
    public function commit($commit)
    {
        ...
        while ($continue) {
            ...
            foreach ($this->temporer_content as $content) {
                ...
                $ct_in = $this->putColumn($content, $colspan, $align, $commit);
     ...
     * @return number
     */
    public function putColumn($content, $colspan, $align, $commit)
    {
