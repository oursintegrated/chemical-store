    ...
    <div class="col-xs-12">
        <div class="card-pf card-pf-accented card-pf-view">
            ...
            <div class="card-pf-body">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{url('/configuration/role/create')}}" class="btn btn-default btn">
                            <li class="fa fa-plus-square"></li> &nbsp; Create Role
                        </a>
                    </div>
                </div>
                <div class="row">
...
<script>
    ...
    var _deleteRole = function(me) {
        ...
        axios.delete("/configuration/role/" + recordID + "/delete")
